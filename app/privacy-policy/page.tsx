...
import PrivacyPolicyEditor from "@/app/components/statute/PrivacyPolicyEditor";
        ...
        <div className="mx-auto max-w-5xl px-6 py-8 md:px-8 md:py-12">
          <div className="mb-8">
            ...
            <p className="mt-2 text-white/70">
              Zarządzaj treścią i historią zmian polityki prywatności
            </p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-[#1a1814] p-8 backdrop-blur-sm">
            <PrivacyPolicyEditor onToast={addToast} />
          </div>
        </div>
      </main>
